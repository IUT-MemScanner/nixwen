...
char *commands[] = {(char *)"cont", (char *)"stop", (char *)"exit",
                    //   (char *)"fsearch",
                    (char *)"fuzzysearch", (char *)"search",
                    //   (char *)"size",
                    (char *)"alter", (char *)"list", (char *)"help",
                    (char *)"fstart", NULL};
...
int main(int argc, char *argv[], char *en[]) {
  ...
  if (pid == 0) {
    ...
    while ((line = readline("> "))) {
      ...
      while (c.substr(c.size() - 1, c.size()) == " ") {
        c.pop_back();
      }
